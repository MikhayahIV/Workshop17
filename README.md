...
3.  **Domain Layer (Rich Domain):** Entidades que validam seus próprios estados.
...
* **Rich Domain Model:** Entidades com comportamentos internos (ex: `ServiceOrder.finishOS()`).
...
Frontend
React | TypeScript | Vite | TanStack Query | Zod | Tailwind CSS
